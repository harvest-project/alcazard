...
SAVE_RESUME_DATA_INTERVAL = 2 * 24 * 60 * 60  # Save resume data for all torrents (that need it) every 2 days
UPDATE_SESSION_STATS_INTERVAL = 1  # Interval in seconds for updating session stats
SHUTDOWN_TIMEOUT = 600  # Seconds to wait for alerts during shutdown to be processed
